...
var EnsureMinLength = function EnsureMinLength(numOrString, len) {
	var str = typeof numOrString === 'number' ? numOrString.toString() : numOrString;
...
var GetTime = function GetTime(ms) {

	var numberOfSeconds = ms / 1000;
	var numberOfMinutes = Math.floor(numberOfSeconds / 60);

	var hours = Math.floor(numberOfMinutes / 60);
	var minutes = Math.floor(numberOfMinutes % 60);
	var seconds = Math.round(numberOfSeconds % 60);

	var m = EnsureMinLength(minutes, 2);
	var s = EnsureMinLength(seconds, 2);
...
exports.default = {
	...
	methods: {
		...
		moveCursorMarker: function moveCursorMarker(e) {
			var _this = this;

			var w = this.$refs.player.getBoundingClientRect().width;
			var l = e.offsetX;

			var percent = l / w;

			var duration = function () {
				var d = _this.$refs.audio.duration;
...
// module
exports.push([module.i, "\n.player {\n  position: relative;\n  height: 70px;\n  z-index: 2;\n  transition: opacity 0.2s ease;\n  padding: 0 30px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  background: rgba(46, 84, 145, 0.15);\n}\n.player.no-bg {\n    background-color: none;\n}\n.player:hover .cursor-marker::before {\n    height: 100%;\n    width: 100%;\n}\n.player:hover .cursor-marker span {\n    opacity: 0.5;\n    top: 6px;\n}\n.player > *:not(.cursor-marker):hover ~ .cursor-marker::before {\n    opacity: 0;\n}\n.player > *:not(.cursor-marker):hover ~ .cursor-marker span {\n    opacity: 0;\n}\n.player .cursor-marker {\n    position: absolute;\n    top: 0;\n    bottom: 0;\n    left: 0;\n    transform: translate(-50%, -50%);\n    width: 2px;\n}\n.player .cursor-marker::before {\n      content: ' ';\n      opacity: 0.5;\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      height: 0;\n      width: 2;\n      background-color: #2E5491;\n      transition: height 0.2s ease;\n      will-change: height;\n      transform: translateX(-50%);\n}\n.player .cursor-marker span {\n      position: absolute;\n      top: 10px;\n      left: 50%;\n      transform: translateX(-50%);\n      padding: 5px;\n      border-radius: 3px;\n      background-color: #2E5491;\n      color: white;\n      opacity: 0;\n      transition: opacity 0.2s ease, top 0.2s ease;\n}\n.player .tracker {\n    position: absolute;\n    top: 0;\n    bottom: 0;\n    left: 0;\n    background-color: #2E5491;\n    opacity: 0.25;\n    z-index: 1;\n    pointer-events: none;\n}\n.player .play-button {\n    height: 45px;\n    width: 45px;\n    border-radius: 50%;\n    background-color: #2E5491;\n    position: relative;\n    cursor: pointer;\n    z-index: 2;\n}\n.player .play-button:active {\n      opacity: 0.8;\n}\n.player .play-button.pause::before {\n      transform: translate(calc(-50% - 5px), -50%);\n      border-top-width: 0;\n      border-bottom-width: 0;\n      border-right-width: 0;\n      height: 15px;\n}\n.player .play-button.pause::after {\n      transform: translate(-50%, -50%);\n      position: absolute;\n      border-top-width: 0;\n      border-bottom-width: 0;\n      border-right-width: 0;\n      height: 15px;\n}\n.player .play-button::before, .player .play-button::after {\n      transition: transform 0.2s ease, height 0.2s ease, border 0.2s ease;\n      will-change: transform, height, border;\n}\n.player .play-button::before {\n      content: ' ';\n      position: absolute;\n      top: 50%;\n      left: 51%;\n      transform: translate(-50%, -50%);\n      border: 5px solid white;\n      border-top: 4px solid transparent;\n      border-bottom: 4px solid transparent;\n      border-right-width: 0;\n      height: 8px;\n}\n.player .play-button::after {\n      content: ' ';\n      position: absolute;\n      top: 50%;\n      left: 62%;\n      transform: translate(-50%, -50%);\n      border: 5px solid white;\n      border-top: 4px solid transparent;\n      border-bottom: 4px solid transparent;\n      border-right: 0;\n      opacity: 1;\n      height: 0;\n}\n.player .timer {\n    padding: 5px;\n    border-radius: 3px;\n    background-color: #2E5491;\n    color: white;\n    font-size: 12px;\n    letter-spacing: 2px;\n    z-index: 2;\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    ...
    {
      ref: "player",
      staticClass: "player noselect",
      on: {
        mousemove: function($event) {
          if ($event.target !== $event.currentTarget) {
            return null
          }
          return _vm.moveCursorMarker($event)
        }
      }
    },
    [
      _c("audio", {
        ...
        on: {
          canplaythrough: function($event) {
            _vm.trackerClickable = true
          }
        }
      }),
      _c("div", { ref: "tracker", staticClass: "tracker" }),
      _c("div", {
        staticClass: "play-button",
        class: { pause: _vm.audioPlaying },
        on: { click: _vm.togglePlaying }
      }),
      _c("div", { staticClass: "timer" }, [
        _vm._v(
          _vm._s(_vm.currentTime) + "/" + _vm._s(_vm.GetTime(_vm.duration))
        )
      ]),
      _c(
        "div",
        {
          ref: "marker",
          staticClass: "cursor-marker",
          on: { click: _vm.updateTime }
        },
        [_c("span", [_vm._v(_vm._s(_vm.cursorTime.string))])]
      )
    ]
  )
}
